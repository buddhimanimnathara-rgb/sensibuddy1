...
import 'assessment_screen_5.dart';
...
class AssessmentScreen4 extends StatefulWidget {
  ...
  @override
  State<AssessmentScreen4> createState() => _AssessmentScreen4State();
}
...
class _AssessmentScreen4State extends State<AssessmentScreen4> {
  ...
  final List<String> questions = [
    ...
    "Does your child have difficulty adapting to new situations?",

    "Does your child repeat words or phrases frequently?",

    "Does your child repeat the same movements repeatedly?",

    "Does your child repeatedly play with toys in the same way?",
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        ...
                        builder: (_) => AssessmentScreen5(
                          childId: widget.childId,
                          previousAnswers: List<bool?>.from(allAnswers),
                          previousScore: totalScore,

                          socialScore: widget.socialScore,
                          communicationScore: widget.communicationScore,
                          restrictedRoutineScore: widget.restrictedRoutineScore,
                          repetitiveScore: pageScore,
                        ),
